  ...
  return (
    <footer className="bg-zinc-900 text-white py-12">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className="text-xl font-bold flex items-center gap-2">
              ...
              <span>Shivam Kumar Sharma</span>
            </div>
            <p className="text-gray-400 max-w-xs">
              Full Stack Developer specializing in MERN stack development, RESTful APIs, and scalable web applications.
            </p>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <a href="mailto:shivambhardwaj750000@gmail.com" className="text-gray-400 hover:text-blue-400 transition-colors">
                  shivambhardwaj750000@gmail.com
                </a>
              </li>
              <li className="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-400" viewBox="0 0 20 20" fill="currentColor">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">Greater Noida, India</span>
              </li>
            </ul>
            ...
            <div className="flex space-x-4 mt-4">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center text-gray-400 hover:bg-blue-600 hover:text-white transition-all"
              >
        ...
        >
          <p>&copy; {currentYear} Shivam Kumar Sharma. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
